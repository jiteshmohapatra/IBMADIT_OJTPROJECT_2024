<% 
    ...
    } else if (!"user".equals(role) && !"both".equals(role)) {
        // Redirect admins to the admin dashboard if trying to access user pages
...
<div class="container-fluid bg-light p-0 wow fadeIn" data-wow-delay="0.1s">
    ...
    <a class="btn btn-sm-square bg-white text-primary me-1" href="https://www.facebook.com/profile.php?id=61566268673655&mibextid=ZbWKwL" target="_blank"><i class="fab fa-facebook-f"></i></a>
    <a class="btn btn-sm-square bg-white text-primary me-1" href="https://x.com/wildhaven_bbsr" target="_blank"><i class="fab fa-twitter"></i></a>
    <a class="btn btn-sm-square bg-white text-primary me-1" href="https://www.linkedin.com/in/wild-haven/" target="_blank"><i class="fab fa-linkedin-in"></i></a>
    <a class="btn btn-sm-square bg-white text-primary" href="https://www.instagram.com/wildhaven_bbsr?igsh=c2RldjVpZ3U0eXFw" target="_blank"><i class="fab fa-instagram"></i></a>
</div>
        </div>
    </div>
</div>
  ...
  <!-- Navbar Start -->
    ...
    <div class="collapse navbar-collapse py-4 py-lg-0" id="navbarCollapse">
      <div class="navbar-nav ms-auto">
        <form action="https://www.google.com/search" method="GET" class="hm-searchbox" target="_blank">
          <input type="search" id="search" name="q" target="_blank" placeholder="Search Google or type URL" />
    ...
    %>
      <div class="nav-item dropdown username">
        <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown">
         <span class="text-success text-capitalize"><%= userName %></span>
        </a>
        <div class="dropdown-menu rounded-0 rounded-bottom m-0">
