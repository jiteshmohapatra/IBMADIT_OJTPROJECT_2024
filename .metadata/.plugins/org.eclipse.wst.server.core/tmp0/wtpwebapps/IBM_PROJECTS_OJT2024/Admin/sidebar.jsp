    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic4" aria-expanded="false" aria-controls="ui-basic1">
                <span class="menu-title">Species Database</span>
<i class="icon-layers menu-icon"></i>
            </a>
            <div class="collapse" id="ui-basic4">
                <ul class="nav flex-column sub-menu">
                    <!-- <li class="nav-item"> <a class="nav-link" href="add-admin.jsp">Add Admin</a></li> -->
                     <li class="nav-item"> <a class="nav-link" href="/CrudOperation">Manage Species</a></li>
                </ul>
            </div>
        </li>
...
<i class="icon-phone menu-icon"></i>
            ...
            <div class="collapse" id="ui-basic5">
                <ul class="nav flex-column sub-menu">
                     <li class="nav-item"> <a class="nav-link" href="contact-manage.jsp">Manage Contacts</a></li>
                </ul>
            </div>
        </li>
